...
public class LineTypeDTO extends ClassificationCommonDTO {
	...
	public LineTypeDTO getParent() {
		return parent;
	}

	public void setParent(LineTypeDTO parent) {
		this.parent = parent;
	}
}
